                    ...
                    case 2:
                        {
                            ...
                            //if (flights == null)
                            //{
                            //    Console.WriteLine("You have not any flights to update them, please fill it firsly !");
                            //    Thread.Sleep(200);
                            //    continue;
                            //}
                            //foreach (var item in flights)
                            ...
                            //}
                            //int i = 0;
                            //Console.Write("Enter which flight you want to update : ");
                            //int.TryParse(Console.ReadLine(), out i);
                            //try
                            //{
                            //    flights[i - 1] = CreateFlight();
                            //}
                            //catch (IndexOutOfRangeException ex)
                            //{
                            //    Console.WriteLine($"You have been putted wrong index !!!\n{ex.Message}");
                            //    Thread.Sleep(2000);
                            //    continue;
                            //}
                            break;
                    ...
                    case 3:
                        {
                            ...
                            //}
                            //int i = 0;
                            //Console.Write("Enter which flight you want to delete : ");
                            //int.TryParse(Console.ReadLine(), out i);
                            //try
                            //{
                            //    flights.Remove(flights[i - 1]);
                            //}
                            //catch (IndexOutOfRangeException ex)
                            //{
                            //    Console.WriteLine($"You have been putted wrong index !!!\n{ex.Message}");
