    ...
    public class Menu
    {
        ...
        public static Terminal CreateTerminal()
        {
            ...
            try
            {
                ...
                int [] gates = new int[result];
                for (int i = 0; i < result; ++i)
                {
                    gates[i] = i+1;
                }
                Terminal terminal = new Terminal(name, gates);
                return terminal;
            }
            catch (Exception ex)
            {
                Console.WriteLine("You have problems with creating terminal !\n" + ex.Message);
            }
            return new Terminal();
        }
        public static Airplane CreateAirplane()
        {
            ...
            {
                Console.WriteLine("You have problems with creating airplane !\n" + ex.Message);
            }
            return new Airplane();
        }
        public static Airport CreateAirport()
        {
            ...
            {
                Console.WriteLine("You have problems with creating Airport !\n" + ex.Message);
            }
            return new Airport();
        }
        public static Flight CreateFlight()
        {
            ...
            try
            {
                ...
                string secondName = "Ruslanovich";
                string nationality = "Ukrainian";
                Prices prices = new Prices(100, 150, 180, 250);
                List<Passenger> passengers = new() { new Passenger(DateOnly.Parse("16-08-2022"), 5, firstName, secondName, nationality, Passenger.sex.Male) };
            ...
            {
                Console.WriteLine("You have some problems while creating Flight !\n" + ex.Message);
            }
            return new Flight(DateTime.Now);
        }
        ...
        public static List<Flight> AddDataToList()
        {
            ...
            {
                Console.WriteLine("You have problem with adding data to list !\n" + ex.Message);
            }
            return list;
        }
